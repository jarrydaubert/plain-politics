...
- Revisit trigger: If retrieval benchmark relevance/support misses target for two consecutive release cycles, evaluate dedicated lexical engine.
...
- Date: 2026-02-20
- Decision: Use 5 primary decision metrics (citation CTR, answer support, citation relevance QA, freshness SLA, 30-day return); keep remaining metrics as secondary diagnostics.
