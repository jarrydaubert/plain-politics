...
> Point-in-time report preserved from 2026-07-21. It records the product and repository as assessed on that date and does not set current priorities. See `docs/project/backlog.md` for unfinished outcomes and order.
